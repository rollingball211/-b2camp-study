...
public class Servlet04 extends GenericServlet {
  ...
  //      =>HTTP 프로토콜의 명령을 분석하여 그 명령을 처리할 메서드를 호출함.
  //       =>GET 명령: Serlvet04.doGet(HttpServletRequest, HttpServletResponse)
  //       => POST 명령: Serlvet04.doPost(HttpServletRequest, HttpServletResponse)
  //         =>Head 명령: Servlet04.doHead(HttpServletRequest, HttpServletResponse)
  @Override
